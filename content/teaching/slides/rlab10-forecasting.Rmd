...
> **Download `acc_select_tax_rev` from eLC.**

> **Open `acc_select_tax_rev` in Excel or whatever spreadsheet software you have**

> **Please do not work ahead yet**

---
# Non-statistical forecast

- Statistical forecasting does not necessarily produce the best forecast

- Two common non-statistical methods:
  - Expert judgement
  - Delphi method
  
- Let's put a non-statistical approach to the test...
