...
- `acc_taxrev` contains annual property tax and sales tax revenues for Athens-Clarke County from 1992-2023

> **In a new code chunk, set `acc_taxrev` as a TS object.**

```{r, eval=FALSE}
ts_taxrev <- ts(acc_taxrev[,-1], start = 1992, end = 2023, 
               frequency = 1)
```
