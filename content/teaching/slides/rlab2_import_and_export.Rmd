...
**Not required**, but you can change the theme of your document (similar to themed templates in Microsoft Office) like below.
...
> **Let's examine whether data look clean**
...
- Data has some undesirable qualities
  ...
  - Note that the rectangle of data we want to import runs from cells A7 (top-left) to D230
...
> **Notice there is a "Range" option in the bottom left. Enter `A7:D230`.**
...
- Good way to get all text, graphs, and tables in a draft Word document

- Can then format accordingly

---
# Knit to PDF

- To knit to PDF, you can install a version of a program called LaTeX 
...
> **Export `ga_schdist_raw` to a csv file. Name the file "ga_schdist_clean.csv"**
